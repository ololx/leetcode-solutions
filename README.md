...
<table>
  <tr>
    ...
    <tr>
        <td>2169</td>
        <td>2169. Count Operations to Obtain Zero</td>
    ...
    <tr>
        <td>1342</td>
        <td>1342. Number of Steps to Reduce a Number to Zero</td>
    ...
    <tr>
        <td>2220</td>
        <td>2220. Minimum Bit Flips to Convert Number</td>
    ...
    <tr>
        <td>844</td>
        <td>844. Backspace String Compare</td>
    ...
    <tr>
        <td>2000</td>
        <td>2000. Reverse Prefix of Word</td>
    ...
    <tr>
        <td>1768</td>
        <td>1768. Merge Strings Alternately</td>
    ...
    <tr>
        <td>2119</td>
        <td>2119. A Number After a Double Reversal</td>
    ...
    <tr>
        <td>1356</td>
        <td>1356. Sort Integers by The Number of 1 Bits</td>
    ...
    <tr>
        <td>2108</td>
        <td>2108. Find First Palindromic String in the Array</td>
    ...
    <tr>
        <td>1009</td>
        <td>1009. Complement of Base 10 Integer</td>
    ...
    <tr>
        <td>1694</td>
        <td>1694. Reformat Phone Number</td>
    ...
    <tr>
        <td>2042</td>
        <td>2042. Check if Numbers Are Ascending in a Sentence</td>
    ...
    <tr>
        <td>278</td>
        <td>0. UNKNOWN</td>
        <td><a href="https://github.com/ololx/leetcode-solutions/tree/main/src/main/java/io/github/ololx/leetcode/solutions/easy/task278/VersionControl.java">VersionControl</a></td>
        <td>easy</td>
    </tr>
    <tr>
        <td>682</td>
        <td>682. Baseball Game</td>
    ...
    <tr>
        <td>2124</td>
        <td>2124. Check if All A's Appears Before All B's</td>
    ...
    <tr>
        <td>946</td>
        <td>946. Validate Stack Sequences</td>
    ...
    <tr>
        <td>1115</td>
        <td>1115. Print FooBar Alternately</td>
    ...
    <tr>
        <td>856</td>
        <td>856. Score of Parentheses</td>
    ...
    <tr>
        <td>1679</td>
        <td>1679. Max Number of K-Sum Pairs</td>
    ...
    <tr>
        <td>1249</td>
        <td>1249. Minimum Remove to Make Valid Parentheses</td>
    ...
    <tr>
        <td>2090</td>
        <td>2090. K Radius Subarray Averages</td>
    ...
    <tr>
        <td>1116</td>
        <td>1116. Print Zero Even Odd</td>
    ...
    <tr>
        <td>82</td>
        <td>0. UNKNOWN</td>
        <td><a href="https://github.com/ololx/leetcode-solutions/tree/main/src/main/java/io/github/ololx/leetcode/solutions/medium/task82/ListNode.java">ListNode</a></td>
        <td>medium</td>
    </tr>
    <tr>
        <td>284</td>
    ...
    <tr>
        <td>792</td>
        <td>792. Number of Matching Subsequences</td>
    ...
    <tr>
        <td>1195</td>
        <td>1195. Fizz Buzz Multithreaded</td>
    ...
    <tr>
        <td>304</td>
        <td>304. Range Sum Query 2D - Immutable</td>
