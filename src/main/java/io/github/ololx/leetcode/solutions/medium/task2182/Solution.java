package io.github.ololx.leetcode.solutions.medium.task2182;
 ...
 * Note that the string "zzcccca" is lexicographically larger but the letter 'c' appears more
 * than 3 times in a row, so it is not a valid repeatLimitedString.</p>
 *
 * Example 2:
 ...
 * Note that the string "bbabaaa" is lexicographically larger but the letter 'a' appears more
 * than 2 times in a row, so it is not a valid repeatLimitedString.</p>
 *
 * Constraints:
 * <ul>
 *      <li>
