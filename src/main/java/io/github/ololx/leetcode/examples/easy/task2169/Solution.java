 ...
 *         However, if num1 = 4 and num2 = 5, after one operation,
 *         num1 = 4 and num2 = 1.
 *     </li>
 * </ul>
 ...
 * So the total number of operations required is 3.</p>
 *
 * Example 2:
 * <p>Input: num1 = 10, num2 = 10
 * Output: 1
 * Explanation:
 * - Operation 1: num1 = 10, num2 = 10. Since num1 == num2,
 * we subtract num2 from num1 and get num1 = 10 - 10 = 0.
 * Now num1 = 0 and num2 = 10. Since num1 == 0, we are done.
 * So the total number of operations required is 1.</p>
 *
 * Constraints:
 * <ul>
 *      <li>
